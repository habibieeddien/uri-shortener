...
function yourls_html_logo() {
	...
	<header role="banner">
	<h1>
		<a href="<?php echo yourls_admin_url( 'index.php' ) ?>" title="YOURLS"><span>PASTIGANA</span>: <span>P</span>usat <span>A</span>nalisis <span>Situasi</span> <span>Siaga</span> Bencana<br/>
		<img src="<?php yourls_site_url(); ?>/images/pastigana.png" alt="YOURLS" title="YOURLS" border="0" style="border: 0px;" /></a>
	</h1>
	</header>
	<?php
...
function yourls_html_head( $context = 'index', $title = '' ) {
	...
	// Page title
	$_title = 'Pastigana URL Shortener | ' . yourls_link();
...
<head>
	...
	<meta name="generator" content="Pastigana <?php echo YOURLS_VERSION ?>" />
	<meta name="description" content="Pastigana &raquo; Pastigana URL Shortener' | <?php yourls_site_url(); ?>" />
